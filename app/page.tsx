...
import { ExternalLink, ChevronDown, Star, Zap, Target } from "lucide-react"
...
const projects = [
  ...
  {
    title: "Rogue[36]",
    description: "Cybersecurity toolkit for network vulnerability assessment.",
    longDescription:
      "Comprehensive security analysis platform that identifies potential vulnerabilities and provides actionable insights for network hardening and threat mitigation.",
    technologies: ["Python", "Nmap", "Metasploit", "Docker", "Vue.js"],
    status: "concept" as const,
    gradient: "from-red-500 to-orange-600",
    githubUrl: "https://github.com/yourusername/rogue-36",
  },
]
    ...
    <>
      ...
      <div className="min-h-screen bg-background text-foreground scroll-smooth">
        ...
        <main className="pt-16 sm:pt-20">
          ...
          {/* Brand Section */}
          <section id="brand" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-muted/20 relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-primary/5 rounded-full blur-2xl animate-pulse"></div>
              <div
                className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-accent/5 rounded-full blur-3xl animate-pulse"
                style={{ animationDelay: "1.5s" }}
              ></div>
            </div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
              <div className="text-center mb-12 sm:mb-16 space-y-3 sm:space-y-4">
                ...
                <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto animate-in slide-in-from-bottom-4 duration-700 delay-200 px-4">
                  ROGUE[36] - A creative agency that does all work uniquely. Specializing in UI/UX design with a
                  distinctive approach to digital experiences. In collabration with @brijrajsinghbhati
                </p>
                <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-primary to-accent mx-auto rounded-full animate-in slide-in-from-bottom-4 duration-700 delay-400"></div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
                ...
                <div className="space-y-6 sm:space-y-8 animate-in slide-in-from-left-4 duration-700 delay-600">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      <div className="text-4xl sm:text-5xl lg:text-6xl font-orbitron font-bold text-primary">ROGUE</div>
                      <div className="text-2xl sm:text-3xl lg:text-4xl font-orbitron font-bold text-accent">[36]</div>
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-lg sm:text-xl font-orbitron font-semibold" style={{ color: "#FF5C05" }}>
                        Done Different
                      </h3>
                      <p className="text-base sm:text-lg text-muted-foreground font-mono">Creative Agency • 2025</p>
                      <p className="text-sm sm:text-base text-muted-foreground">Mumbai, India</p>
                    </div>
                    <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                      We do all our work uniquely. SENX[22] represents a new approach to UI/UX design, where creativity
                      meets functionality in unexpected ways. Our agency specializes in crafting digital experiences
                      that stand out from the conventional.
                    </p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                    <div className="text-center p-4 sm:p-6 rounded-lg border border-border/50 bg-background/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300 group cursor-pointer">
                      <div
                        className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 rounded-full flex items-center justify-center"
                        style={{ backgroundColor: "#FF5C05" }}
                      >
                      ...
                      <p className="text-xs text-muted-foreground">Done Different approach</p>
                    </div>
                    ...
                    <div className="text-center p-4 sm:p-6 rounded-lg border border-border/50 bg-background/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300 group cursor-pointer">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <h4 className="text-base sm:text-lg font-orbitron font-semibold text-primary">Services</h4>
                    <div className="grid grid-cols-2 gap-3 sm:gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: "#FF5C05" }}></div>
                ...
                {/* Brand Assets */}
                <div className="animate-in slide-in-from-right-4 duration-700 delay-800">
                  <div className="space-y-4 sm:space-y-6">
                    <h3 className="text-xl sm:text-2xl font-orbitron font-semibold text-primary">Brand Assets</h3>

                    {/* Official Brand Asset */}
                    <div className="mb-4 sm:mb-6 p-4 sm:p-6 rounded-lg border border-border/50 bg-background/30 backdrop-blur-sm">
                      <h4 className="font-orbitron font-semibold text-sm mb-3 sm:mb-4">Official Brand Asset</h4>
                      <div className="w-full max-w-md mx-auto rounded-lg overflow-hidden shadow-lg">
                        <img
                          src="/images/rogue-brand-asset.png"
                          alt="ROGUE[36] Brand Identity Asset"
                          className="w-full h-auto"
                        />
                      </div>
                      <p className="text-xs text-muted-foreground mt-2 text-center">
                        Official ROGUE[36] brand identity showcase
                      </p>
                    </div>

                    {/* Logo Variations Display */}
                    <div className="grid grid-cols-2 gap-3 sm:gap-4">
                      <div className="text-center p-4 sm:p-6 rounded-lg border border-border/50 bg-background/30 backdrop-blur-sm">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-3 sm:mb-4 rounded-lg bg-white flex items-center justify-center shadow-lg">
                          <div
                            className="text-lg sm:text-xl lg:text-2xl font-orbitron font-bold"
                            style={{ color: "#222222" }}
                          >
                            RO[36]
                          </div>
                        </div>
                        <h4 className="font-orbitron font-semibold text-xs sm:text-sm mb-1">Fill Version</h4>
                        <p className="text-xs text-muted-foreground">Primary logo</p>
                      </div>
                      <div className="text-center p-4 sm:p-6 rounded-lg border border-border/50 bg-background/30 backdrop-blur-sm">
                        <div
                          className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-3 sm:mb-4 rounded-lg border-2 flex items-center justify-center"
                        ...
                        <h4 className="font-orbitron font-semibold text-xs sm:text-sm mb-1">Outline Version</h4>
                        <p className="text-xs text-muted-foreground">Alternative logo</p>
                      </div>
                    </div>

                    {/* Brand Guidelines */}
                    <div className="p-4 sm:p-6 rounded-lg bg-background/50 backdrop-blur-sm border border-border/50">
                      <h4 className="font-orbitron font-semibold mb-3 sm:mb-4 text-primary">Brand Guidelines</h4>
                      <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              ...
                              style={{ backgroundColor: "#FF5C05" }}
                            ></div>
                            <span className="font-mono">#FF5C05</span>
                          </div>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              ...
                              style={{ backgroundColor: "#222222" }}
                            ></div>
                            <span className="font-mono">#222222</span>
                          </div>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-muted-foreground">Header Font:</span>
                          <span className="font-orbitron">Lure</span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span>Creative • Unique • Different</span>
                        </div>
                      </div>
                    </div>
                  </div>
